	...
	<body>
        ...
        <div class="searchbar" style="padding:30px"> 
            ...
            <?php include "Includes/template/nav.php";?>
                <div>
					<center><h1>Update Orarin</h1></center>
                </div> 
                    <?php
				    ...
				    $ushtrimet = $dita = $terminet = $klasa = $ligjeratat = $ditael = $klasael = "";
			
					//kushti if ne kete rast do te plotesohet vetem pasi klikohet butoni Submit ne formen
					if($_SERVER['REQUEST_METHOD'] == 'POST') {
						//POST
						
						include 'Includes/functions/selectUpdateOrariNgaAdmini.php';
					}
					?>
                    <form action = "<?php echo $_SERVER['PHP_SELF'];?>" method = "POST">
                        <center><table>
                            <tr style="float:right">
                                <td><input type="button" onClick= "location.href='perpilimioraritngaadmin.php';" value="Insert Orari" style="
                            ...
                            <tr class="exams">
								<th class ='exams'> ID e Orarit <br>
                                    <select name = "id" style ="width:100%">
                                        <option value="<?php $id = "Perzgjidh ID:";
                                        echo $id;?>">
                                        <?php echo $id;?></option>
                                        <?php include "Includes/functions/selectOrariID.php";?>			
                                    </select>
                                </th>
